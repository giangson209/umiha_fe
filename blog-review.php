<?php include 'header.php';?>
    <main>
        <section class="box-banner-bread">
            <div class="avarta-bread"><img src="images/bn-2.png" class="img-fluid w-100" alt=""></div>
        ...
        <section class="box-tab-blog">
            <div class="container">
                <div class="tab-blog">
                    <ul>
                        <li><a href="javascript:void(0)" data-tab="tab-1" class="clc-tab active">Báo chí nói gì?</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-2" class="clc-tab">KOLs nói gì?</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-1" class="clc-tab">Khác hàng nói gì?</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-2" class="clc-tab">Khử mùi cơ thể</a></li>
                    </ul>
                </div>
        ...
        <section class="box-banner-sale pb-0">
            <div class="content-banner-sale sale-cate">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <div class="txt-sale">
                                <h3 class="text-uppercase">bộ sản phẩm chăm sóc</h3>
                                <div class="btn-main"><a href="">XEM THÊM</a></div>
                            </div>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="avr"><img src="images/avr-sale-1.png" class="img-fluid" alt=""></div>
                        </div>
                        <div class="col-md-4">
