                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="item-method">
                                                <input type="radio" id="1001" name="method" class="method-rad" checked>
                                                <label for="1001">
                                                    <span class="icon">
                                            ...
                                            <div class="item-method">
                                                <input type="radio" id="1002" name="method" class="method-rad">
                                                <label for="1002">
                                                    <span class="icon">
                        ...
                        <div class="side-pay">
                            ...
                            <div class="card-payment">
                                <div class="item-prd-pay">
                                    <div class="avarta"><a href=""><img src="images/prd-pay.png" class="img-fluid w-100" alt=""></a></div>
                                    <div class="info">
                                        <div class="top">
                                            <a href="">Xịt dưỡng tóc</a>
