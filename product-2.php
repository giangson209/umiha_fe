...
<main>
    <section class="box-about bn-prd-2">
        <div class="container">
            <div class="caption-about">
                <div class="row">
                    <div class="col-md-3">
                        <div class="title-caption">Chăm sóc cơ thể</div>
                    </div>
                    <div class="col-md-3">
                        <div class="txt-caption">
                            A sublingual, or under-the-tongue application directly impacts the bloodstream, allowing for the quickest absorption and benefit to the mind and body. Relying on CBD to activate receptor sites in the mind and body, MINERAL formulates whole-plant sublinguals
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="txt-content-prd">
                            <h4>Sản phẩm <br>triệt lông</h4>
                            <div class="desc">he inclusion of whole-plant materials, including fats, vitamins, and amino acids, provides a familiar substance to the body creating a formulation that is readily available for absorption.</div>
